...
import br.com.jeanclaro.gestao_vagas.exceptions.JobNotFoundException;
...
import br.com.jeanclaro.gestao_vagas.modules.candidate.entity.ApplyJobEntity;
import br.com.jeanclaro.gestao_vagas.modules.candidate.repository.ApplyJobRepository;
import br.com.jeanclaro.gestao_vagas.modules.company.entities.JobEntity;
import br.com.jeanclaro.gestao_vagas.modules.company.repositories.JobRepository;
...
public class ApplyJobCandidateUseCaseTest {
    ...
    public void should_not_be_able_to_apply_job_with_job_not_found(){
        ...
        //Basicamente falando: Quando chamar o repositório do candidato então retorne esse candidato que criamos
        try {
    ...
    public void should_be_able_to_create_a_new_apply_job(){
        ...
        assertNotNull(result.getId(), "O ID do resultado não deveria ser nulo");
    }
}
